<div>
    ...
    type="text" placeholder="Search" class="border border-gray-300 border-solid text-center p-0">
    ...
    @if ($results!=null)
       <ul class="absolute mt-2 w-auto bg-white p-1 shadow-lg border border-gray-500 border-solid z-10">
         ...
         <li class="flex flex-row items-center justify-between my-1" >
          <a class="font-bold text-blue-500 hover:underline" href="/user/{{ $profile['username'] }}">
            <img src="{{ $profile['profile_photo_url'] }}" alt="/user/{{ $profile['username'] }}" 
