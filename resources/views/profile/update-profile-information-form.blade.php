    ...
    <x-slot name="form">
        ...
        @endif
         ...
         <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="username" type="text" class="mt-1 block w-full" wire:model.defer="state.username" autocomplete="username" disabled/>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="phone" name="phone" type="text" class="mt-1 block w-full" wire:model.defer="state.phone" />
