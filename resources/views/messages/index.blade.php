  ...
  <section class="flex flex-col pt-3 w-4/12 bg-gray-50 h-full overflow-y-scroll">
    ...
    <ul class="mt-6">
      ...
      <li class="py-5 border-b px-3 transition hover:bg-indigo-100">
        <a href="/$mes" class="flex justify-between items-center">
          {{-- {{route('message.show',$mes)}} --}}
          <h3 class="text-lg font-semibold">{{ $mes->user->username }}</h3>
          <p class="text-md text-gray-400">23m ago</p>
        </a>
        <div class="text-md italic text-gray-400">{{ $mes->Subject }}</div>
      </li>
      @empty
    ...
    <div class="flex justify-between items-center h-48 border-b-2 mb-8">
      <div class="flex space-x-4 items-center">
        ...
        <div class="flex flex-col">
          ...
          <p class="text-light text-gray-400">#####</p>
        </div>
      </div>
      <div>
